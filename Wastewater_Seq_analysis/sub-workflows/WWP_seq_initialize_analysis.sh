...
find $fastq_dir -type f -name '*.fastq.gz' -print0 | grep -zf $analysis_dir/$run_name/${run_name}_wastewater_sample_list.csv | parallel -0 "cp {} $analysis_dir/$run_name/raw_data/"
