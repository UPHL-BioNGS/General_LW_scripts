...
After the script has been executed, the Results.txt file should be manually moved to the appropriate directory /Volumes/DDCP/Division Shared Files/DCPIP EDX/UPHL/NGS
Once the file is in the correct location, it will then be moved to AWS for Lab Ware 8 for processing.

To run the Results.R script, you need only one paraeter:runName.

Example:

Rscript Results UT-VH00770-250204
